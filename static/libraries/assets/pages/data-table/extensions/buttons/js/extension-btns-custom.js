        ...
        buttons: [
            {
                ...
                exportOptions: {
                    ...
                    title: 'All Existing Customers Details',
                //    filename: get_val,
            },
            {
                extend: 'print',
            ...
            },
            {
                ...
                titleAttr: 'Excel',
                title: 'All Existing Customers Detail',
                //filename: get_val,
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5, 6, 7, 8]
        ...
        buttons: [
            {
                ...
                exportOptions: {
                    ...
                    title: 'All Available Stock Details',
                //    filename: get_val,
            },
            {
                extend: 'print',
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<h2 class="text-center pt-2">Shoukat Currency Exchange</h2><div class="col-md-12" style="display: flex;justify-content: center;"><img src="https://res.cloudinary.com/dyhg4sjqm/image/upload/v1635770285/Shoukat_CE.png" style="opacity:0.12;width: 50%;position:absolute; top:180px; " /></div>'
                        );
...
<tr>
        <td><div class="dropdown dropdown-action" style="width: 159px;">
            ...
            <a href="/staff_update/{{ staffuser.auth_user_id.id }}/" class="dropdown-item edit_click">
            <i class="fa fa-pencil m-r-5"></i>Edit Details </a>
            <a href="#" class="dropdown-item edit_status "><i class="fa fa-pencil m-r-5"></i>Active</a>
            <a href="#" class="dropdown-item edit_branch_click "><i class="fa fa-pencil m-r-5"></i>View User Role Details </a></div>
            </div>
        </td>
        <td>{{ qs.number|upper }}</td>
        <td>BUY</td>
        <td>{{ qs.total }}</td>    
        <td>{{ qs.pay_type }}</td>    
        <td>{{ qs.client.name }}</td>    
        <td>{{ qs.client.uniqueId }}</td>    
        <td>{{ qs.cashier }}</td>
        <td>{{ qs.notes }}</td>
        <td>{{ qs.created_at }}</td>
        <td></td>
...
<tr>
    ...
    <table cellpadding="5" cellspacing="0" border="0" style="padding-left:150px;">
        ...
        <tbody>
            {% for curr in qs.get_currencyItems %}
            <tr>
                <td>
                    {% if curr.item.code == 'USD' %}
                    <img src="{% static 'libraries/assets/images/widget/USA.jpg' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'GERMANY' %}
                    <img src="{% static 'libraries/assets/images/widget/GERMANY.jpg' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'EUR' %}
                    <img src="{% static 'libraries/assets/images/widget/EUR.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'AED' %}
                    <img src="{% static 'libraries/assets/images/widget/UAE.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'GBP' %}
                    <img src="{% static 'libraries/assets/images/widget/UK.jpg' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'CHF' %}
                    <img src="{% static 'libraries/assets/images/widget/CHF.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'CAD' %}
                    <img src="{% static 'libraries/assets/images/widget/CAD.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'SAR' %}
                    <img src="{% static 'libraries/assets/images/widget/SAR.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'QAR' %}
                    <img src="{% static 'libraries/assets/images/widget/QAR.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'KWD' %}
                    <img src="{% static 'libraries/assets/images/widget/KWD.png' %}" style="height:25px;width:40px;">
                    {% elif curr.item.code == 'OMR' %}
                    <img src="{% static 'libraries/assets/images/widget/OMR.png' %}" style="height:25px;width:40px;">
                    {% else %}
                    <img src="{% static 'libraries/assets/images/widget/no-flag.png' %}" style="height:25px;width:40px;">
                    {% endif %}
                </td>
                <td>{{curr.invoice.number|upper}}</td>
                <td>{{curr.item}}</td>
                <td>{{curr.amount}}</td>
                <td>{{curr.rate}}</td>
                <td>{{curr.subtotal}}</td>
